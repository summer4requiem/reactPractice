...
const Dialogs = (props) => {
  ...
  let onMessageSend = () => {
    props.dispatch(addNewMessageCreater());
  }
    ...
    <section className={s.dialogs}>
      ...
      <div className={s.dialogsMessages}>
        ...
        <div className={s.dialogsSend}>
          <textarea maxLength="140" onChange={onMessageFieldChange} className={s.dialogsSendTextarea} cname="" id="" value={props.state.newMessageText} />
