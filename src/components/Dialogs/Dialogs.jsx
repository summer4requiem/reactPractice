...
const Dialogs = (props) => {
  ...
  let onMessageFieldChange = () => {
    ...
    props.updateMessageFieldText(text);
  }
    ...
    <section className={s.dialogs}>
      ...
      <div className={s.dialogsMessages}>
        ...
        <div className={s.dialogsSend}>
          <textarea maxLength="140" onChange={onMessageFieldChange} ref={newMessage} className={s.dialogsSendTextarea} cname="" id="" value={props.state.newMessageText} />
